...
def main():
    ...
    error = []
    error_mol = []
    df = pd.read_csv("/home/boittier/Documents/Tautomers/databases/QM9_cleaned.csv")
    data = []

    missing = open("/home/boittier/Documents/Tautomers/QM9_missing.txt")
    ...
    for i, row in df.iterrows():
        ...
        if mol is not None: #and len(mol.GetAtoms()) < 9:
            data.append(row[2])
            atoms = mol.GetAtoms()
